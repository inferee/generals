...
public class GameStart {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		ArrayDeque<Move>[] queues = new ArrayDeque[] { new ArrayDeque<Move>(), new ArrayDeque<Move>() };
		Player[] players = new Player[] { new PlayerGraphics(18, 18, 2, 1, queues[0]),
				new PlayerGraphics(18, 18, 2, 2, queues[1]) };
		GameBoard g = new GameBoard(board, players, queues, new Spectator[0], 0.1, 0.1, 2, 9, 7);
		// GameBoard g = new GameBoard(18, 18, 0.1, 0.04, 2, 15, 9);
		// GameBoard g = new GameBoard(18, 18, 0.1, 0.04, 8, 8, 4);
